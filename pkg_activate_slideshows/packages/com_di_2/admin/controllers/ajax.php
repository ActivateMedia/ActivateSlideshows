...
class DiControllerAjax extends JControllerAdmin
{
	...
	public function upload()
	{
		...
		$object_component 	= JRequest::get( 'component', 'com_content' );
		$object_component = $object_component["component"];
		$object_view   	= JRequest::get( 'view', 'article' );
		$object_view = $object_view["view"];
	...
	{
		$action 	= JRequest::getString( 'way', 'way' ); // questo viene da /media/com_di/js/images.js richiesta AJAX
		$object_id 	= JRequest::getInt( 'object_id', 0 );
		...
		{
			$list = plgContentImages::getImages($action, $object_id, true );
