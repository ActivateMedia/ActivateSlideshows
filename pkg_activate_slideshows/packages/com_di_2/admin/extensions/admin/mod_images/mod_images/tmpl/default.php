...
<!--  uploadify  -->
<link rel="stylesheet" href="<?php echo JUri::root(); ?>media/com_di/js/uploadify/uploadify.css" type="text/css" />
<script src="<?php echo JUri::root(); ?>media/com_di/js/uploadify/jquery.uploadify-3.1.js" type="text/javascript"></script>
