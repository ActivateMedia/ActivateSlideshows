...
class com_diInstallerScript
{
	...
	{
		$db 				= JFactory::getDBO();
		$extensions_path 	= JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_di' . DS . 'extensions';
		
		//  admin extensions
		$extensions_path_admin = $extensions_path . DS . 'admin';
		...
		//  site extensions
		$extensions_path_site = $extensions_path . DS . 'site';
		...
		{
			$filename 	= $extensions_path_admin . DS . $item[ 'filename' ] . '.zip';
		...
		{
			$filename 	= $extensions_path_site . DS . $item[ 'filename' ] . '.zip';
			$package 	= JInstallerHelper::unpack( $filename );
