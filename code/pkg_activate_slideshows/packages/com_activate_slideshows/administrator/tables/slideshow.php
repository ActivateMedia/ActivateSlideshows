...
/**
 * slideshow Table class
 */
class Activate_slideshowsTableslideshow extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__activate_slideshows_slideshows', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'save' || $task == 'apply') && (!JFactory::getUser()->authorise('core.edit.state','com_activate_slideshows') && $array['state'] == 1)){
			$array['state'] = 0;
		}
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_activate_slideshows.slideshow.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_activate_slideshows', 'slideshow');
            $default_actions = JFactory::getACL()->getAssetRules('com_activate_slideshows.slideshow.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_activate_slideshows.slideshow.' . (int) $this->$k;
    }
    ...
    protected function _getAssetParentId(JTable $table = null, $id = null) {
        ...
        $assetParent->loadByName('com_activate_slideshows');
